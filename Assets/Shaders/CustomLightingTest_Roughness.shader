...
Shader "CustomLightingTest_Roughness"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float dotResult53 = dot( i.worldNormal , ase_worldlightDir );
			float dotResult637 = dot( i.worldNormal , i.viewDir );
			float3 temp_cast_0 = (dotResult637).xxx;
			float temp_output_696_0 = ( 1.0 - lerpResult738 );
			float lerpResult632 = lerp( ( ase_lightAtten * dotResult53 ) , Luminance(temp_cast_0) , ( _SpecularStrength * temp_output_696_0 ));
			...
			float2 temp_cast_3 = (_BrushTextureTiling).xx;
			...
			float4 tex2DNode23_g556 = tex2D( _BrushTexture, ( ( ( temp_cast_3 * 0.75 ).x * appendResult7_g556 ) + float4( ( _TextureOffset4 + ( _Time.y * _MouvSpeed * -1.0 ) ), 0.0 , 0.0 ) ).xy );
			float2 temp_cast_8 = (_BrushTextureTiling).xx;
			float4 appendResult6_g556 = (float4(transform46_g556.z , transform46_g556.y , 0.0 , 0.0));
			float4 transform47_g556 = mul(unity_WorldToObject,float4( i.worldNormal , 0.0 ));
			...
			float4 lerpResult26_g556 = lerp( tex2DNode23_g556 , tex2D( _BrushTexture, ( ( ( temp_cast_8 * 0.75 ).x * appendResult6_g556 ) + float4( ( _TextureOffset4 + ( _Time.y * _MouvSpeed * -1.0 ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g556, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float2 temp_cast_17 = (_BrushTextureTiling).xx;
			...
			float4 lerpResult32_g556 = lerp( lerpResult29_g556 , tex2D( _BrushTexture, ( ( ( temp_cast_17 * 0.75 ).x * appendResult13_g556 ) + float4( ( _TextureOffset4 + ( _Time.y * _MouvSpeed * -1.0 ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g556, 0.0 , 0.0 )) , 5.0 ) ).r);
			float2 temp_cast_23 = (_BrushTextureTiling).xx;
			...
			float4 tex2DNode23_g555 = tex2D( _BrushTexture, ( ( temp_cast_23.x * appendResult7_g555 ) + float4( ( _TextureOffset4 + ( _Time.y * _MouvSpeed ) ), 0.0 , 0.0 ) ).xy );
			float2 temp_cast_28 = (_BrushTextureTiling).xx;
			float4 appendResult6_g555 = (float4(transform46_g555.z , transform46_g555.y , 0.0 , 0.0));
			float4 transform47_g555 = mul(unity_WorldToObject,float4( i.worldNormal , 0.0 ));
			...
			float4 lerpResult26_g555 = lerp( tex2DNode23_g555 , tex2D( _BrushTexture, ( ( temp_cast_28.x * appendResult6_g555 ) + float4( ( _TextureOffset4 + ( _Time.y * _MouvSpeed ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g555, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float2 temp_cast_37 = (_BrushTextureTiling).xx;
			...
			float4 lerpResult32_g555 = lerp( lerpResult29_g555 , tex2D( _BrushTexture, ( ( temp_cast_37.x * appendResult13_g555 ) + float4( ( _TextureOffset4 + ( _Time.y * _MouvSpeed ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g555, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float2 temp_cast_48 = (_BrushStrokeTiling).xx;
			...
			float4 tex2DNode23_g558 = tex2D( _BrushStrokeTexture, ( ( temp_cast_48.x * appendResult7_g558 ) + float4( _TextureOffset4, 0.0 , 0.0 ) ).xy );
			float2 temp_cast_53 = (_BrushStrokeTiling).xx;
			float4 appendResult6_g558 = (float4(transform46_g558.z , transform46_g558.y , 0.0 , 0.0));
			float4 transform47_g558 = mul(unity_WorldToObject,float4( i.worldNormal , 0.0 ));
			...
			float4 lerpResult26_g558 = lerp( tex2DNode23_g558 , tex2D( _BrushStrokeTexture, ( ( temp_cast_53.x * appendResult6_g558 ) + float4( _TextureOffset4, 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g558, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float2 temp_cast_62 = (_BrushStrokeTiling).xx;
			...
			float4 lerpResult32_g558 = lerp( lerpResult29_g558 , tex2D( _BrushStrokeTexture, ( ( temp_cast_62.x * appendResult13_g558 ) + float4( _TextureOffset4, 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g558, 0.0 , 0.0 )) , 5.0 ) ).r);
			float2 temp_cast_68 = (_BrushStrokeTiling).xx;
			...
			float4 tex2DNode23_g557 = tex2D( _CircleTexture, ( ( temp_cast_68.x * appendResult7_g557 ) + float4( _TextureOffset4, 0.0 , 0.0 ) ).xy );
			float2 temp_cast_73 = (_BrushStrokeTiling).xx;
			float4 appendResult6_g557 = (float4(transform46_g557.z , transform46_g557.y , 0.0 , 0.0));
			float4 transform47_g557 = mul(unity_WorldToObject,float4( i.worldNormal , 0.0 ));
			...
			float4 lerpResult26_g557 = lerp( tex2DNode23_g557 , tex2D( _CircleTexture, ( ( temp_cast_73.x * appendResult6_g557 ) + float4( _TextureOffset4, 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g557, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float2 temp_cast_82 = (_BrushStrokeTiling).xx;
			...
			float4 lerpResult32_g557 = lerp( lerpResult29_g557 , tex2D( _CircleTexture, ( ( temp_cast_82.x * appendResult13_g557 ) + float4( _TextureOffset4, 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g557, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 tex2DNode23_g563 = tex2D( _BrushTexture, ( ( ( temp_cast_96 * 0.75 ).x * appendResult7_g563 ) + float4( ( float2( 0,0 ) + ( _Time.y * _MouvSpeed * -1.0 ) ), 0.0 , 0.0 ) ).xy );
			...
			float4 transform47_g563 = mul(unity_WorldToObject,float4( i.worldNormal , 0.0 ));
			...
			float4 lerpResult26_g563 = lerp( tex2DNode23_g563 , tex2D( _BrushTexture, ( ( ( temp_cast_101 * 0.75 ).x * appendResult6_g563 ) + float4( ( float2( 0,0 ) + ( _Time.y * _MouvSpeed * -1.0 ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g563, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 lerpResult32_g563 = lerp( lerpResult29_g563 , tex2D( _BrushTexture, ( ( ( temp_cast_110 * 0.75 ).x * appendResult13_g563 ) + float4( ( float2( 0,0 ) + ( _Time.y * _MouvSpeed * -1.0 ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g563, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 tex2DNode23_g562 = tex2D( _BrushTexture, ( ( temp_cast_116.x * appendResult7_g562 ) + float4( ( float2( 0,0 ) + ( _Time.y * _MouvSpeed ) ), 0.0 , 0.0 ) ).xy );
			...
			float4 transform47_g562 = mul(unity_WorldToObject,float4( i.worldNormal , 0.0 ));
			...
			float4 lerpResult26_g562 = lerp( tex2DNode23_g562 , tex2D( _BrushTexture, ( ( temp_cast_121.x * appendResult6_g562 ) + float4( ( float2( 0,0 ) + ( _Time.y * _MouvSpeed ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g562, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 lerpResult32_g562 = lerp( lerpResult29_g562 , tex2D( _BrushTexture, ( ( temp_cast_130.x * appendResult13_g562 ) + float4( ( float2( 0,0 ) + ( _Time.y * _MouvSpeed ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g562, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 tex2DNode23_g565 = tex2D( _BrushStrokeTexture, ( ( temp_cast_141.x * appendResult7_g565 ) + float4( float2( 0,0 ), 0.0 , 0.0 ) ).xy );
			float2 temp_cast_146 = (_BrushStrokeTiling).xx;
			float4 appendResult6_g565 = (float4(transform46_g565.z , transform46_g565.y , 0.0 , 0.0));
			float4 transform47_g565 = mul(unity_WorldToObject,float4( i.worldNormal , 0.0 ));
			...
			float4 lerpResult26_g565 = lerp( tex2DNode23_g565 , tex2D( _BrushStrokeTexture, ( ( temp_cast_146.x * appendResult6_g565 ) + float4( float2( 0,0 ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g565, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 lerpResult32_g565 = lerp( lerpResult29_g565 , tex2D( _BrushStrokeTexture, ( ( temp_cast_155.x * appendResult13_g565 ) + float4( float2( 0,0 ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g565, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 tex2DNode23_g564 = tex2D( _CircleTexture, ( ( temp_cast_161.x * appendResult7_g564 ) + float4( float2( 0,0 ), 0.0 , 0.0 ) ).xy );
			float2 temp_cast_166 = (_BrushStrokeTiling).xx;
			float4 appendResult6_g564 = (float4(transform46_g564.z , transform46_g564.y , 0.0 , 0.0));
			float4 transform47_g564 = mul(unity_WorldToObject,float4( i.worldNormal , 0.0 ));
			...
			float4 lerpResult26_g564 = lerp( tex2DNode23_g564 , tex2D( _CircleTexture, ( ( temp_cast_166.x * appendResult6_g564 ) + float4( float2( 0,0 ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g564, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 lerpResult32_g564 = lerp( lerpResult29_g564 , tex2D( _CircleTexture, ( ( temp_cast_175.x * appendResult13_g564 ) + float4( float2( 0,0 ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g564, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float2 temp_cast_189 = (_BrushTextureTiling).xx;
			...
			float4 tex2DNode23_g570 = tex2D( _BrushTexture, ( ( ( temp_cast_189 * 0.75 ).x * appendResult7_g570 ) + float4( ( temp_output_595_0 + ( _Time.y * _MouvSpeed * -1.0 ) ), 0.0 , 0.0 ) ).xy );
			float2 temp_cast_194 = (_BrushTextureTiling).xx;
			float4 appendResult6_g570 = (float4(transform46_g570.z , transform46_g570.y , 0.0 , 0.0));
			float4 transform47_g570 = mul(unity_WorldToObject,float4( i.worldNormal , 0.0 ));
			...
			float4 lerpResult26_g570 = lerp( tex2DNode23_g570 , tex2D( _BrushTexture, ( ( ( temp_cast_194 * 0.75 ).x * appendResult6_g570 ) + float4( ( temp_output_595_0 + ( _Time.y * _MouvSpeed * -1.0 ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g570, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float2 temp_cast_203 = (_BrushTextureTiling).xx;
			...
			float4 lerpResult32_g570 = lerp( lerpResult29_g570 , tex2D( _BrushTexture, ( ( ( temp_cast_203 * 0.75 ).x * appendResult13_g570 ) + float4( ( temp_output_595_0 + ( _Time.y * _MouvSpeed * -1.0 ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g570, 0.0 , 0.0 )) , 5.0 ) ).r);
			float2 temp_cast_209 = (_BrushTextureTiling).xx;
			...
			float4 tex2DNode23_g569 = tex2D( _BrushTexture, ( ( temp_cast_209.x * appendResult7_g569 ) + float4( ( temp_output_595_0 + ( _Time.y * _MouvSpeed ) ), 0.0 , 0.0 ) ).xy );
			float2 temp_cast_214 = (_BrushTextureTiling).xx;
			float4 appendResult6_g569 = (float4(transform46_g569.z , transform46_g569.y , 0.0 , 0.0));
			float4 transform47_g569 = mul(unity_WorldToObject,float4( i.worldNormal , 0.0 ));
			...
			float4 lerpResult26_g569 = lerp( tex2DNode23_g569 , tex2D( _BrushTexture, ( ( temp_cast_214.x * appendResult6_g569 ) + float4( ( temp_output_595_0 + ( _Time.y * _MouvSpeed ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g569, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float2 temp_cast_223 = (_BrushTextureTiling).xx;
			...
			float4 lerpResult32_g569 = lerp( lerpResult29_g569 , tex2D( _BrushTexture, ( ( temp_cast_223.x * appendResult13_g569 ) + float4( ( temp_output_595_0 + ( _Time.y * _MouvSpeed ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g569, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float2 temp_cast_234 = (_BrushStrokeTiling).xx;
			...
			float4 tex2DNode23_g572 = tex2D( _BrushStrokeTexture, ( ( temp_cast_234.x * appendResult7_g572 ) + float4( temp_output_595_0, 0.0 , 0.0 ) ).xy );
			float2 temp_cast_239 = (_BrushStrokeTiling).xx;
			float4 appendResult6_g572 = (float4(transform46_g572.z , transform46_g572.y , 0.0 , 0.0));
			float4 transform47_g572 = mul(unity_WorldToObject,float4( i.worldNormal , 0.0 ));
			...
			float4 lerpResult26_g572 = lerp( tex2DNode23_g572 , tex2D( _BrushStrokeTexture, ( ( temp_cast_239.x * appendResult6_g572 ) + float4( temp_output_595_0, 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g572, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float2 temp_cast_248 = (_BrushStrokeTiling).xx;
			...
			float4 lerpResult32_g572 = lerp( lerpResult29_g572 , tex2D( _BrushStrokeTexture, ( ( temp_cast_248.x * appendResult13_g572 ) + float4( temp_output_595_0, 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g572, 0.0 , 0.0 )) , 5.0 ) ).r);
			float temp_output_605_0 = ( lerpResult730 + 0.025 );
			float2 temp_cast_254 = (_BrushStrokeTiling).xx;
			...
			float4 tex2DNode23_g571 = tex2D( _CircleTexture, ( ( temp_cast_254.x * appendResult7_g571 ) + float4( temp_output_595_0, 0.0 , 0.0 ) ).xy );
			float2 temp_cast_259 = (_BrushStrokeTiling).xx;
			float4 appendResult6_g571 = (float4(transform46_g571.z , transform46_g571.y , 0.0 , 0.0));
			float4 transform47_g571 = mul(unity_WorldToObject,float4( i.worldNormal , 0.0 ));
			...
			float4 lerpResult26_g571 = lerp( tex2DNode23_g571 , tex2D( _CircleTexture, ( ( temp_cast_259.x * appendResult6_g571 ) + float4( temp_output_595_0, 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g571, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float2 temp_cast_268 = (_BrushStrokeTiling).xx;
			...
			float4 lerpResult32_g571 = lerp( lerpResult29_g571 , tex2D( _CircleTexture, ( ( temp_cast_268.x * appendResult13_g571 ) + float4( temp_output_595_0, 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g571, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float2 temp_cast_282 = (_BrushTextureTiling).xx;
			...
			float4 tex2DNode23_g577 = tex2D( _BrushTexture, ( ( ( temp_cast_282 * 0.75 ).x * appendResult7_g577 ) + float4( ( temp_output_613_0 + ( _Time.y * _MouvSpeed * -1.0 ) ), 0.0 , 0.0 ) ).xy );
			float2 temp_cast_287 = (_BrushTextureTiling).xx;
			float4 appendResult6_g577 = (float4(transform46_g577.z , transform46_g577.y , 0.0 , 0.0));
			float4 transform47_g577 = mul(unity_WorldToObject,float4( i.worldNormal , 0.0 ));
			...
			float4 lerpResult26_g577 = lerp( tex2DNode23_g577 , tex2D( _BrushTexture, ( ( ( temp_cast_287 * 0.75 ).x * appendResult6_g577 ) + float4( ( temp_output_613_0 + ( _Time.y * _MouvSpeed * -1.0 ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g577, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float2 temp_cast_296 = (_BrushTextureTiling).xx;
			...
			float4 lerpResult32_g577 = lerp( lerpResult29_g577 , tex2D( _BrushTexture, ( ( ( temp_cast_296 * 0.75 ).x * appendResult13_g577 ) + float4( ( temp_output_613_0 + ( _Time.y * _MouvSpeed * -1.0 ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g577, 0.0 , 0.0 )) , 5.0 ) ).r);
			float2 temp_cast_302 = (_BrushTextureTiling).xx;
			...
			float4 tex2DNode23_g576 = tex2D( _BrushTexture, ( ( temp_cast_302.x * appendResult7_g576 ) + float4( ( temp_output_613_0 + ( _Time.y * _MouvSpeed ) ), 0.0 , 0.0 ) ).xy );
			float2 temp_cast_307 = (_BrushTextureTiling).xx;
			float4 appendResult6_g576 = (float4(transform46_g576.z , transform46_g576.y , 0.0 , 0.0));
			float4 transform47_g576 = mul(unity_WorldToObject,float4( i.worldNormal , 0.0 ));
			...
			float4 lerpResult26_g576 = lerp( tex2DNode23_g576 , tex2D( _BrushTexture, ( ( temp_cast_307.x * appendResult6_g576 ) + float4( ( temp_output_613_0 + ( _Time.y * _MouvSpeed ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g576, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float2 temp_cast_316 = (_BrushTextureTiling).xx;
			...
			float4 lerpResult32_g576 = lerp( lerpResult29_g576 , tex2D( _BrushTexture, ( ( temp_cast_316.x * appendResult13_g576 ) + float4( ( temp_output_613_0 + ( _Time.y * _MouvSpeed ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g576, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float2 temp_cast_327 = (_BrushStrokeTiling).xx;
			...
			float4 tex2DNode23_g579 = tex2D( _BrushStrokeTexture, ( ( temp_cast_327.x * appendResult7_g579 ) + float4( temp_output_613_0, 0.0 , 0.0 ) ).xy );
			float2 temp_cast_332 = (_BrushStrokeTiling).xx;
			float4 appendResult6_g579 = (float4(transform46_g579.z , transform46_g579.y , 0.0 , 0.0));
			float4 transform47_g579 = mul(unity_WorldToObject,float4( i.worldNormal , 0.0 ));
			...
			float4 lerpResult26_g579 = lerp( tex2DNode23_g579 , tex2D( _BrushStrokeTexture, ( ( temp_cast_332.x * appendResult6_g579 ) + float4( temp_output_613_0, 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g579, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float2 temp_cast_341 = (_BrushStrokeTiling).xx;
			...
			float4 lerpResult32_g579 = lerp( lerpResult29_g579 , tex2D( _BrushStrokeTexture, ( ( temp_cast_341.x * appendResult13_g579 ) + float4( temp_output_613_0, 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g579, 0.0 , 0.0 )) , 5.0 ) ).r);
			float temp_output_614_0 = ( temp_output_605_0 + 0.025 );
			float2 temp_cast_347 = (_BrushStrokeTiling).xx;
			...
			float4 tex2DNode23_g578 = tex2D( _CircleTexture, ( ( temp_cast_347.x * appendResult7_g578 ) + float4( temp_output_613_0, 0.0 , 0.0 ) ).xy );
			float2 temp_cast_352 = (_BrushStrokeTiling).xx;
			float4 appendResult6_g578 = (float4(transform46_g578.z , transform46_g578.y , 0.0 , 0.0));
			float4 transform47_g578 = mul(unity_WorldToObject,float4( i.worldNormal , 0.0 ));
			...
			float4 lerpResult26_g578 = lerp( tex2DNode23_g578 , tex2D( _CircleTexture, ( ( temp_cast_352.x * appendResult6_g578 ) + float4( temp_output_613_0, 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g578, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float2 temp_cast_361 = (_BrushStrokeTiling).xx;
			...
			float4 lerpResult32_g578 = lerp( lerpResult29_g578 , tex2D( _CircleTexture, ( ( temp_cast_361.x * appendResult13_g578 ) + float4( temp_output_613_0, 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g578, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float2 temp_cast_375 = (_BrushTextureTiling).xx;
			...
			float4 tex2DNode23_g584 = tex2D( _BrushTexture, ( ( ( temp_cast_375 * 0.75 ).x * appendResult7_g584 ) + float4( ( ( temp_output_613_0 + float2( 0.2,0.2 ) ) + ( _Time.y * _MouvSpeed * -1.0 ) ), 0.0 , 0.0 ) ).xy );
			float2 temp_cast_380 = (_BrushTextureTiling).xx;
			float4 appendResult6_g584 = (float4(transform46_g584.z , transform46_g584.y , 0.0 , 0.0));
			float4 transform47_g584 = mul(unity_WorldToObject,float4( i.worldNormal , 0.0 ));
			...
			float4 lerpResult26_g584 = lerp( tex2DNode23_g584 , tex2D( _BrushTexture, ( ( ( temp_cast_380 * 0.75 ).x * appendResult6_g584 ) + float4( ( ( temp_output_613_0 + float2( 0.2,0.2 ) ) + ( _Time.y * _MouvSpeed * -1.0 ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g584, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float2 temp_cast_389 = (_BrushTextureTiling).xx;
			...
			float4 lerpResult32_g584 = lerp( lerpResult29_g584 , tex2D( _BrushTexture, ( ( ( temp_cast_389 * 0.75 ).x * appendResult13_g584 ) + float4( ( ( temp_output_613_0 + float2( 0.2,0.2 ) ) + ( _Time.y * _MouvSpeed * -1.0 ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g584, 0.0 , 0.0 )) , 5.0 ) ).r);
			float2 temp_cast_395 = (_BrushTextureTiling).xx;
			...
			float4 tex2DNode23_g583 = tex2D( _BrushTexture, ( ( temp_cast_395.x * appendResult7_g583 ) + float4( ( ( temp_output_613_0 + float2( 0.2,0.2 ) ) + ( _Time.y * _MouvSpeed ) ), 0.0 , 0.0 ) ).xy );
			float2 temp_cast_400 = (_BrushTextureTiling).xx;
			float4 appendResult6_g583 = (float4(transform46_g583.z , transform46_g583.y , 0.0 , 0.0));
			float4 transform47_g583 = mul(unity_WorldToObject,float4( i.worldNormal , 0.0 ));
			...
			float4 lerpResult26_g583 = lerp( tex2DNode23_g583 , tex2D( _BrushTexture, ( ( temp_cast_400.x * appendResult6_g583 ) + float4( ( ( temp_output_613_0 + float2( 0.2,0.2 ) ) + ( _Time.y * _MouvSpeed ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g583, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float2 temp_cast_409 = (_BrushTextureTiling).xx;
			...
			float4 lerpResult32_g583 = lerp( lerpResult29_g583 , tex2D( _BrushTexture, ( ( temp_cast_409.x * appendResult13_g583 ) + float4( ( ( temp_output_613_0 + float2( 0.2,0.2 ) ) + ( _Time.y * _MouvSpeed ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g583, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float2 temp_cast_420 = (_BrushStrokeTiling).xx;
			...
			float4 tex2DNode23_g586 = tex2D( _BrushStrokeTexture, ( ( temp_cast_420.x * appendResult7_g586 ) + float4( ( temp_output_613_0 + float2( 0.2,0.2 ) ), 0.0 , 0.0 ) ).xy );
			float2 temp_cast_425 = (_BrushStrokeTiling).xx;
			float4 appendResult6_g586 = (float4(transform46_g586.z , transform46_g586.y , 0.0 , 0.0));
			float4 transform47_g586 = mul(unity_WorldToObject,float4( i.worldNormal , 0.0 ));
			...
			float4 lerpResult26_g586 = lerp( tex2DNode23_g586 , tex2D( _BrushStrokeTexture, ( ( temp_cast_425.x * appendResult6_g586 ) + float4( ( temp_output_613_0 + float2( 0.2,0.2 ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g586, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float2 temp_cast_434 = (_BrushStrokeTiling).xx;
			...
			float4 lerpResult32_g586 = lerp( lerpResult29_g586 , tex2D( _BrushStrokeTexture, ( ( temp_cast_434.x * appendResult13_g586 ) + float4( ( temp_output_613_0 + float2( 0.2,0.2 ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g586, 0.0 , 0.0 )) , 5.0 ) ).r);
			float2 temp_cast_440 = (_BrushStrokeTiling).xx;
			...
			float4 tex2DNode23_g585 = tex2D( _CircleTexture, ( ( temp_cast_440.x * appendResult7_g585 ) + float4( ( temp_output_613_0 + float2( 0.2,0.2 ) ), 0.0 , 0.0 ) ).xy );
			float2 temp_cast_445 = (_BrushStrokeTiling).xx;
			float4 appendResult6_g585 = (float4(transform46_g585.z , transform46_g585.y , 0.0 , 0.0));
			float4 transform47_g585 = mul(unity_WorldToObject,float4( i.worldNormal , 0.0 ));
			...
			float4 lerpResult26_g585 = lerp( tex2DNode23_g585 , tex2D( _CircleTexture, ( ( temp_cast_445.x * appendResult6_g585 ) + float4( ( temp_output_613_0 + float2( 0.2,0.2 ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g585, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float2 temp_cast_454 = (_BrushStrokeTiling).xx;
			...
			float4 lerpResult32_g585 = lerp( lerpResult29_g585 , tex2D( _CircleTexture, ( ( temp_cast_454.x * appendResult13_g585 ) + float4( ( temp_output_613_0 + float2( 0.2,0.2 ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g585, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			g297.roughness = 1.0;
			g297.reflUVW = reflect( -data.worldViewDir, ase_worldNormal );
			float3 indirectSpecular297 = UnityGI_IndirectSpecular( data, 1.0, ase_worldNormal, g297 );
...
/*ASEBEGIN
Version=13201
1927;29;1906;1004;5960.245;2461.963;7.624413;True;True
...
Node;AmplifyShaderEditor.SamplerNode;257;2137.629,1223.22;Float;True;Property;_Albedo;Albedo;4;0;None;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.SamplerNode;551;-2319.552,1530.266;Float;True;Property;_Normal;Normal;5;0;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;FLOAT3;FLOAT;FLOAT;FLOAT;FLOAT
...
ASEEND*/
//CHKSM=93898882843401E2B0F2337848B85F8CCBEC018A