...
Shader "CustomLightingTest_Roughness"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 lerpResult116 = lerp( ( lerpResult291 * lerpResult363 ) , ( lerpResult733 * ( lerpResult700 * lerpResult725 ) ) , saturate( ( tex2D( _Ramp, appendResult5_g552.xy ) + ( lerpResult12_g546 * tex2D( _Ramp, appendResult5_g551.xy ) ) ) ).r);
			...
			float4 tex2DNode23_g556 = tex2D( _BrushTexture, ( ( ( temp_cast_97 * 0.75 ).x * appendResult7_g556 ) + float4( ( float2( 0,0 ) + ( _Time.y * _MouvSpeed * -1.0 ) ), 0.0 , 0.0 ) ).xy );
			...
			float4 lerpResult26_g556 = lerp( tex2DNode23_g556 , tex2D( _BrushTexture, ( ( ( temp_cast_102 * 0.75 ).x * appendResult6_g556 ) + float4( ( float2( 0,0 ) + ( _Time.y * _MouvSpeed * -1.0 ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g556, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 lerpResult32_g556 = lerp( lerpResult29_g556 , tex2D( _BrushTexture, ( ( ( temp_cast_111 * 0.75 ).x * appendResult13_g556 ) + float4( ( float2( 0,0 ) + ( _Time.y * _MouvSpeed * -1.0 ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g556, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 tex2DNode23_g555 = tex2D( _BrushTexture, ( ( temp_cast_117.x * appendResult7_g555 ) + float4( ( float2( 0,0 ) + ( _Time.y * _MouvSpeed ) ), 0.0 , 0.0 ) ).xy );
			...
			float4 lerpResult26_g555 = lerp( tex2DNode23_g555 , tex2D( _BrushTexture, ( ( temp_cast_122.x * appendResult6_g555 ) + float4( ( float2( 0,0 ) + ( _Time.y * _MouvSpeed ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g555, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 lerpResult32_g555 = lerp( lerpResult29_g555 , tex2D( _BrushTexture, ( ( temp_cast_131.x * appendResult13_g555 ) + float4( ( float2( 0,0 ) + ( _Time.y * _MouvSpeed ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g555, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float temp_output_4_0_g560 = saturate( (Luminance(( ( tex2D( _Ramp, appendResult5_g553.xy ) + CalculateContrast(1.25,lerpResult54_g554) ) * tex2D( _Ramp, appendResult5_g553.xy ) ).xyz)*3.0 + temp_output_732_0) );
			...
			float4 tex2DNode23_g558 = tex2D( _BrushStrokeTexture, ( ( temp_cast_142.x * appendResult7_g558 ) + float4( float2( 0,0 ), 0.0 , 0.0 ) ).xy );
			...
			float4 lerpResult26_g558 = lerp( tex2DNode23_g558 , tex2D( _BrushStrokeTexture, ( ( temp_cast_147.x * appendResult6_g558 ) + float4( float2( 0,0 ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g558, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 lerpResult32_g558 = lerp( lerpResult29_g558 , tex2D( _BrushStrokeTexture, ( ( temp_cast_156.x * appendResult13_g558 ) + float4( float2( 0,0 ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g558, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 tex2DNode23_g557 = tex2D( _CircleTexture, ( ( temp_cast_162.x * appendResult7_g557 ) + float4( float2( 0,0 ), 0.0 , 0.0 ) ).xy );
			...
			float4 lerpResult26_g557 = lerp( tex2DNode23_g557 , tex2D( _CircleTexture, ( ( temp_cast_167.x * appendResult6_g557 ) + float4( float2( 0,0 ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g557, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 lerpResult32_g557 = lerp( lerpResult29_g557 , tex2D( _CircleTexture, ( ( temp_cast_176.x * appendResult13_g557 ) + float4( float2( 0,0 ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g557, 0.0 , 0.0 )) , 5.0 ) ).r);
			float4 lerpResult12_g554 = lerp( float4( 0,0,0,0 ) , lerpResult32_g558 , step( lerpResult730 , Luminance(( lerpResult32_g557 * tex2D( _Ramp, appendResult5_g553.xy ) ).rgb) ));
			float temp_output_4_0_g559 = saturate( (0.0*0.2 + _LightSoftStepStrokes) );
			float4 appendResult5_g559 = (float4(temp_output_4_0_g559 , temp_output_4_0_g559 , 0.0 , 0.0));
			float4 lerpResult319 = lerp( lerpResult116 , ( ( tex2DNode257 + ( temp_output_273_0 * 0.25 ) ) * lerpResult733 ) , saturate( ( tex2D( _Ramp, appendResult5_g560.xy ) + ( lerpResult12_g554 * tex2D( _Ramp, appendResult5_g559.xy ) ) ) ).r);
			...
			float4 tex2DNode23_g563 = tex2D( _BrushTexture, ( ( ( temp_cast_190 * 0.75 ).x * appendResult7_g563 ) + float4( ( temp_output_595_0 + ( _Time.y * _MouvSpeed * -1.0 ) ), 0.0 , 0.0 ) ).xy );
			...
			float4 lerpResult26_g563 = lerp( tex2DNode23_g563 , tex2D( _BrushTexture, ( ( ( temp_cast_195 * 0.75 ).x * appendResult6_g563 ) + float4( ( temp_output_595_0 + ( _Time.y * _MouvSpeed * -1.0 ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g563, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 lerpResult32_g563 = lerp( lerpResult29_g563 , tex2D( _BrushTexture, ( ( ( temp_cast_204 * 0.75 ).x * appendResult13_g563 ) + float4( ( temp_output_595_0 + ( _Time.y * _MouvSpeed * -1.0 ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g563, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 tex2DNode23_g562 = tex2D( _BrushTexture, ( ( temp_cast_210.x * appendResult7_g562 ) + float4( ( temp_output_595_0 + ( _Time.y * _MouvSpeed ) ), 0.0 , 0.0 ) ).xy );
			...
			float4 lerpResult26_g562 = lerp( tex2DNode23_g562 , tex2D( _BrushTexture, ( ( temp_cast_215.x * appendResult6_g562 ) + float4( ( temp_output_595_0 + ( _Time.y * _MouvSpeed ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g562, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 lerpResult32_g562 = lerp( lerpResult29_g562 , tex2D( _BrushTexture, ( ( temp_cast_224.x * appendResult13_g562 ) + float4( ( temp_output_595_0 + ( _Time.y * _MouvSpeed ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g562, 0.0 , 0.0 )) , 5.0 ) ).r);
			float4 lerpResult54_g561 = lerp( lerpResult32_g563 , lerpResult32_g562 , 0.5);
			float temp_output_612_0 = ( temp_output_732_0 + -0.1 );
			float temp_output_4_0_g567 = saturate( (Luminance(( ( tex2D( _Ramp, appendResult5_g553.xy ) + CalculateContrast(1.25,lerpResult54_g561) ) * tex2D( _Ramp, appendResult5_g553.xy ) ).xyz)*3.0 + temp_output_612_0) );
			...
			float4 tex2DNode23_g565 = tex2D( _BrushStrokeTexture, ( ( temp_cast_235.x * appendResult7_g565 ) + float4( temp_output_595_0, 0.0 , 0.0 ) ).xy );
			...
			float4 lerpResult26_g565 = lerp( tex2DNode23_g565 , tex2D( _BrushStrokeTexture, ( ( temp_cast_240.x * appendResult6_g565 ) + float4( temp_output_595_0, 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g565, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 lerpResult32_g565 = lerp( lerpResult29_g565 , tex2D( _BrushStrokeTexture, ( ( temp_cast_249.x * appendResult13_g565 ) + float4( temp_output_595_0, 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g565, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 tex2DNode23_g564 = tex2D( _CircleTexture, ( ( temp_cast_255.x * appendResult7_g564 ) + float4( temp_output_595_0, 0.0 , 0.0 ) ).xy );
			...
			float4 lerpResult26_g564 = lerp( tex2DNode23_g564 , tex2D( _CircleTexture, ( ( temp_cast_260.x * appendResult6_g564 ) + float4( temp_output_595_0, 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g564, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 lerpResult32_g564 = lerp( lerpResult29_g564 , tex2D( _CircleTexture, ( ( temp_cast_269.x * appendResult13_g564 ) + float4( temp_output_595_0, 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g564, 0.0 , 0.0 )) , 5.0 ) ).r);
			float4 lerpResult12_g561 = lerp( float4( 0,0,0,0 ) , lerpResult32_g565 , step( temp_output_605_0 , Luminance(( lerpResult32_g564 * tex2D( _Ramp, appendResult5_g553.xy ) ).rgb) ));
			...
			float4 lerpResult149 = lerp( lerpResult319 , ( ( tex2DNode257 + ( temp_output_273_0 * 0.5 ) ) * lerpResult733 ) , saturate( ( tex2D( _Ramp, appendResult5_g567.xy ) + ( lerpResult12_g561 * tex2D( _Ramp, appendResult5_g566.xy ) ) ) ).r);
			...
			float4 tex2DNode23_g570 = tex2D( _BrushTexture, ( ( ( temp_cast_283 * 0.75 ).x * appendResult7_g570 ) + float4( ( temp_output_613_0 + ( _Time.y * _MouvSpeed * -1.0 ) ), 0.0 , 0.0 ) ).xy );
			...
			float4 lerpResult26_g570 = lerp( tex2DNode23_g570 , tex2D( _BrushTexture, ( ( ( temp_cast_288 * 0.75 ).x * appendResult6_g570 ) + float4( ( temp_output_613_0 + ( _Time.y * _MouvSpeed * -1.0 ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g570, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 lerpResult32_g570 = lerp( lerpResult29_g570 , tex2D( _BrushTexture, ( ( ( temp_cast_297 * 0.75 ).x * appendResult13_g570 ) + float4( ( temp_output_613_0 + ( _Time.y * _MouvSpeed * -1.0 ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g570, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 tex2DNode23_g569 = tex2D( _BrushTexture, ( ( temp_cast_303.x * appendResult7_g569 ) + float4( ( temp_output_613_0 + ( _Time.y * _MouvSpeed ) ), 0.0 , 0.0 ) ).xy );
			...
			float4 lerpResult26_g569 = lerp( tex2DNode23_g569 , tex2D( _BrushTexture, ( ( temp_cast_308.x * appendResult6_g569 ) + float4( ( temp_output_613_0 + ( _Time.y * _MouvSpeed ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g569, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 lerpResult32_g569 = lerp( lerpResult29_g569 , tex2D( _BrushTexture, ( ( temp_cast_317.x * appendResult13_g569 ) + float4( ( temp_output_613_0 + ( _Time.y * _MouvSpeed ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g569, 0.0 , 0.0 )) , 5.0 ) ).r);
			float4 lerpResult54_g568 = lerp( lerpResult32_g570 , lerpResult32_g569 , 0.5);
			float temp_output_615_0 = ( temp_output_612_0 + -0.1 );
			float temp_output_4_0_g574 = saturate( (Luminance(( ( tex2D( _Ramp, appendResult5_g553.xy ) + CalculateContrast(1.25,lerpResult54_g568) ) * tex2D( _Ramp, appendResult5_g553.xy ) ).xyz)*3.0 + temp_output_615_0) );
			...
			float4 tex2DNode23_g572 = tex2D( _BrushStrokeTexture, ( ( temp_cast_328.x * appendResult7_g572 ) + float4( temp_output_613_0, 0.0 , 0.0 ) ).xy );
			...
			float4 lerpResult26_g572 = lerp( tex2DNode23_g572 , tex2D( _BrushStrokeTexture, ( ( temp_cast_333.x * appendResult6_g572 ) + float4( temp_output_613_0, 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g572, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 lerpResult32_g572 = lerp( lerpResult29_g572 , tex2D( _BrushStrokeTexture, ( ( temp_cast_342.x * appendResult13_g572 ) + float4( temp_output_613_0, 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g572, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 tex2DNode23_g571 = tex2D( _CircleTexture, ( ( temp_cast_348.x * appendResult7_g571 ) + float4( temp_output_613_0, 0.0 , 0.0 ) ).xy );
			...
			float4 lerpResult26_g571 = lerp( tex2DNode23_g571 , tex2D( _CircleTexture, ( ( temp_cast_353.x * appendResult6_g571 ) + float4( temp_output_613_0, 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g571, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 lerpResult32_g571 = lerp( lerpResult29_g571 , tex2D( _CircleTexture, ( ( temp_cast_362.x * appendResult13_g571 ) + float4( temp_output_613_0, 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g571, 0.0 , 0.0 )) , 5.0 ) ).r);
			float4 lerpResult12_g568 = lerp( float4( 0,0,0,0 ) , lerpResult32_g572 , step( temp_output_614_0 , Luminance(( lerpResult32_g571 * tex2D( _Ramp, appendResult5_g553.xy ) ).rgb) ));
			...
			float4 lerpResult177 = lerp( lerpResult149 , ( ( tex2DNode257 + ( temp_output_273_0 * 0.75 ) ) * lerpResult733 ) , saturate( ( tex2D( _Ramp, appendResult5_g574.xy ) + ( lerpResult12_g568 * tex2D( _Ramp, appendResult5_g573.xy ) ) ) ).r);
			...
			float4 tex2DNode23_g577 = tex2D( _BrushTexture, ( ( ( temp_cast_376 * 0.75 ).x * appendResult7_g577 ) + float4( ( ( temp_output_613_0 + float2( 0.2,0.2 ) ) + ( _Time.y * _MouvSpeed * -1.0 ) ), 0.0 , 0.0 ) ).xy );
			...
			float4 lerpResult26_g577 = lerp( tex2DNode23_g577 , tex2D( _BrushTexture, ( ( ( temp_cast_381 * 0.75 ).x * appendResult6_g577 ) + float4( ( ( temp_output_613_0 + float2( 0.2,0.2 ) ) + ( _Time.y * _MouvSpeed * -1.0 ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g577, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 lerpResult32_g577 = lerp( lerpResult29_g577 , tex2D( _BrushTexture, ( ( ( temp_cast_390 * 0.75 ).x * appendResult13_g577 ) + float4( ( ( temp_output_613_0 + float2( 0.2,0.2 ) ) + ( _Time.y * _MouvSpeed * -1.0 ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g577, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 tex2DNode23_g576 = tex2D( _BrushTexture, ( ( temp_cast_396.x * appendResult7_g576 ) + float4( ( ( temp_output_613_0 + float2( 0.2,0.2 ) ) + ( _Time.y * _MouvSpeed ) ), 0.0 , 0.0 ) ).xy );
			...
			float4 lerpResult26_g576 = lerp( tex2DNode23_g576 , tex2D( _BrushTexture, ( ( temp_cast_401.x * appendResult6_g576 ) + float4( ( ( temp_output_613_0 + float2( 0.2,0.2 ) ) + ( _Time.y * _MouvSpeed ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g576, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 lerpResult32_g576 = lerp( lerpResult29_g576 , tex2D( _BrushTexture, ( ( temp_cast_410.x * appendResult13_g576 ) + float4( ( ( temp_output_613_0 + float2( 0.2,0.2 ) ) + ( _Time.y * _MouvSpeed ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g576, 0.0 , 0.0 )) , 5.0 ) ).r);
			float4 lerpResult54_g575 = lerp( lerpResult32_g577 , lerpResult32_g576 , 0.5);
			float temp_output_4_0_g581 = saturate( (Luminance(( ( tex2D( _Ramp, appendResult5_g553.xy ) + CalculateContrast(1.25,lerpResult54_g575) ) * tex2D( _Ramp, appendResult5_g553.xy ) ).xyz)*3.0 + ( temp_output_615_0 + -0.1 )) );
			...
			float4 tex2DNode23_g579 = tex2D( _BrushStrokeTexture, ( ( temp_cast_421.x * appendResult7_g579 ) + float4( ( temp_output_613_0 + float2( 0.2,0.2 ) ), 0.0 , 0.0 ) ).xy );
			...
			float4 lerpResult26_g579 = lerp( tex2DNode23_g579 , tex2D( _BrushStrokeTexture, ( ( temp_cast_426.x * appendResult6_g579 ) + float4( ( temp_output_613_0 + float2( 0.2,0.2 ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g579, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 lerpResult32_g579 = lerp( lerpResult29_g579 , tex2D( _BrushStrokeTexture, ( ( temp_cast_435.x * appendResult13_g579 ) + float4( ( temp_output_613_0 + float2( 0.2,0.2 ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g579, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 tex2DNode23_g578 = tex2D( _CircleTexture, ( ( temp_cast_441.x * appendResult7_g578 ) + float4( ( temp_output_613_0 + float2( 0.2,0.2 ) ), 0.0 , 0.0 ) ).xy );
			...
			float4 lerpResult26_g578 = lerp( tex2DNode23_g578 , tex2D( _CircleTexture, ( ( temp_cast_446.x * appendResult6_g578 ) + float4( ( temp_output_613_0 + float2( 0.2,0.2 ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask5_g578, 0.0 , 0.0 )) , 5.0 ) ).r);
			...
			float4 lerpResult32_g578 = lerp( lerpResult29_g578 , tex2D( _CircleTexture, ( ( temp_cast_455.x * appendResult13_g578 ) + float4( ( temp_output_613_0 + float2( 0.2,0.2 ) ), 0.0 , 0.0 ) ).xy ) , saturate( pow( CalculateContrast(4.0,float4( componentMask17_g578, 0.0 , 0.0 )) , 5.0 ) ).r);
			float4 lerpResult12_g575 = lerp( float4( 0,0,0,0 ) , lerpResult32_g579 , step( ( temp_output_614_0 + 0.025 ) , Luminance(( lerpResult32_g578 * tex2D( _Ramp, appendResult5_g553.xy ) ).rgb) ));
			...
			float4 lerpResult254 = lerp( lerpResult177 , ( ( tex2DNode257 + temp_output_273_0 ) * lerpResult733 ) , saturate( ( tex2D( _Ramp, appendResult5_g581.xy ) + ( lerpResult12_g575 * tex2D( _Ramp, appendResult5_g580.xy ) ) ) ).r);
...
/*ASEBEGIN
Version=13201
1939;127;1684;906;-1757.604;-854.3796;1.301547;True;True
...
Node;AmplifyShaderEditor.SamplerNode;551;-2319.552,1530.266;Float;True;Property;_Normal;Normal;5;0;Assets/Textures/T_Briques_N.tga;True;0;False;bump;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;FLOAT3;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.SamplerNode;257;2137.629,1223.22;Float;True;Property;_Albedo;Albedo;4;0;Assets/Textures/T_OldPaper01_A.png;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.FunctionNode;691;2511.044,2716.022;Float;False;SHDF_LightStep;1;;554;11;0;FLOAT4;0,0,0,0;False;1;SAMPLER2D;;False;2;SAMPLER2D;;False;3;SAMPLER2D;;False;4;SAMPLER2D;;False;5;FLOAT2;0,0;False;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT;0.0;False;9;FLOAT;0.0;False;10;FLOAT;0.0;False;1;COLOR
...
Node;AmplifyShaderEditor.FunctionNode;692;2509.603,3340.643;Float;False;SHDF_LightStep;1;;561;11;0;FLOAT4;0,0,0,0;False;1;SAMPLER2D;;False;2;SAMPLER2D;;False;3;SAMPLER2D;;False;4;SAMPLER2D;;False;5;FLOAT2;0,0;False;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT;0.0;False;9;FLOAT;0.0;False;10;FLOAT;0.0;False;1;COLOR
...
Node;AmplifyShaderEditor.FunctionNode;693;2513.361,3826.772;Float;False;SHDF_LightStep;1;;568;11;0;FLOAT4;0,0,0,0;False;1;SAMPLER2D;;False;2;SAMPLER2D;;False;3;SAMPLER2D;;False;4;SAMPLER2D;;False;5;FLOAT2;0,0;False;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT;0.0;False;9;FLOAT;0.0;False;10;FLOAT;0.0;False;1;COLOR
...
Node;AmplifyShaderEditor.FunctionNode;694;2530.311,4306.258;Float;False;SHDF_LightStep;1;;575;11;0;FLOAT4;0,0,0,0;False;1;SAMPLER2D;;False;2;SAMPLER2D;;False;3;SAMPLER2D;;False;4;SAMPLER2D;;False;5;FLOAT2;0,0;False;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT;0.0;False;9;FLOAT;0.0;False;10;FLOAT;0.0;False;1;COLOR
...
ASEEND*/
//CHKSM=2D56ADE1E337A65D02E8F4D6FC776C87DB4B808F