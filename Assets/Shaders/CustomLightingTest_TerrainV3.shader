...
Shader "CustomLightingTest_Terrain03"
{
	Properties
	{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 tex2DNode744 = tex2D( _Control, uv_Control );
			float4 lerpResult748 = lerp( tex2D( _Splat0, uv_Splat0 ) , tex2DNode746 , tex2DNode744.r);
			float4 lerpResult750 = lerp( lerpResult748 , tex2DNode746 , tex2DNode744.g);
			float2 uv_Splat2 = i.uv_texcoord * _Splat2_ST.xy + _Splat2_ST.zw;
			float4 lerpResult752 = lerp( lerpResult750 , tex2D( _Splat2, uv_Splat2 ) , tex2DNode744.b);
			float2 uv_Splat3 = i.uv_texcoord * _Splat3_ST.xy + _Splat3_ST.zw;
			float4 lerpResult754 = lerp( lerpResult752 , tex2D( _Splat3, uv_Splat3 ) , tex2DNode744.a);
			float4 lerpResult733 = lerp( _LightColor0 , lerpResult754 , ( _Metalness * 0.5 ));
			...
			float4 lerpResult700 = lerp( ( lerpResult754 * ( lerpResult754 * 0.5 ) ) , lerpResult754 , lerpResult738);
			...
			float4 lerpResult319 = lerp( lerpResult116 , ( ( lerpResult754 + ( temp_output_273_0 * 0.25 ) ) * lerpResult733 ) , saturate( ( tex2D( _Ramp, appendResult5_g567.xy ) + ( lerpResult12_g561 * tex2D( _Ramp, appendResult5_g566.xy ) ) ) ).r);
			...
			float4 lerpResult149 = lerp( lerpResult319 , ( ( lerpResult754 + ( temp_output_273_0 * 0.5 ) ) * lerpResult733 ) , saturate( ( tex2D( _Ramp, appendResult5_g574.xy ) + ( lerpResult12_g568 * tex2D( _Ramp, appendResult5_g573.xy ) ) ) ).r);
			...
			float4 lerpResult177 = lerp( lerpResult149 , ( ( lerpResult754 + ( temp_output_273_0 * 0.75 ) ) * lerpResult733 ) , saturate( ( tex2D( _Ramp, appendResult5_g581.xy ) + ( lerpResult12_g575 * tex2D( _Ramp, appendResult5_g580.xy ) ) ) ).r);
			...
			float4 lerpResult254 = lerp( lerpResult177 , ( ( lerpResult754 + temp_output_273_0 ) * lerpResult733 ) , saturate( ( tex2D( _Ramp, appendResult5_g588.xy ) + ( lerpResult12_g582 * tex2D( _Ramp, appendResult5_g587.xy ) ) ) ).r);
...
/*ASEBEGIN
Version=13201
1927;29;1906;1004;3366.715;413.6301;3.20822;True;True
Node;AmplifyShaderEditor.TexturePropertyNode;743;36.2905,36.86312;Float;True;Property;_Control;Control;18;0;None;False;white;Auto;0;1;SAMPLER2D
Node;AmplifyShaderEditor.TexturePropertyNode;741;387.7223,297.5805;Float;True;Property;_Splat0;Splat0;23;0;None;False;white;Auto;0;1;SAMPLER2D
Node;AmplifyShaderEditor.TexturePropertyNode;742;389.4519,515.7846;Float;True;Property;_Splat1;Splat1;27;0;None;False;white;Auto;0;1;SAMPLER2D
Node;AmplifyShaderEditor.SamplerNode;746;687.2198,515.2385;Float;True;Property;_TextureSample7;Texture Sample 7;24;0;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.SamplerNode;745;687.2198,298.0651;Float;True;Property;_TextureSample4;Texture Sample 4;24;0;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.SamplerNode;744;289.6816,36.72072;Float;True;Property;_TextureSample2;Texture Sample 2;24;0;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.LerpOp;748;1184.143,334.8742;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0,0,0,0;False;1;COLOR
...
Node;AmplifyShaderEditor.TexturePropertyNode;747;384.2574,740.9181;Float;True;Property;_Splat2;Splat2;26;0;None;False;white;Auto;0;1;SAMPLER2D
Node;AmplifyShaderEditor.LerpOp;750;1388.433,482.1104;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0,0,0,0;False;1;COLOR
...
Node;AmplifyShaderEditor.TexturePropertyNode;749;395.3918,969.887;Float;True;Property;_Splat3;Splat3;25;0;None;False;white;Auto;0;1;SAMPLER2D
Node;AmplifyShaderEditor.SamplerNode;751;689.0609,739.7738;Float;True;Property;_TextureSample9;Texture Sample 9;24;0;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.SamplerNode;551;-2319.552,1530.266;Float;True;Property;_Normal;Normal;3;0;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;FLOAT3;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.SamplerNode;753;685.3797,966.15;Float;True;Property;_TextureSample11;Texture Sample 11;24;0;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.LerpOp;752;1605.607,669.8365;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0,0,0,0;False;1;COLOR
Node;AmplifyShaderEditor.LerpOp;754;1809.898,844.6796;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0.0,0,0,0;False;1;COLOR
...
Node;AmplifyShaderEditor.LerpOp;733;2600.831,1047.143;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0,0,0,0;False;1;COLOR
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;697;2846.48,1283.802;Float;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR
...
Node;AmplifyShaderEditor.TexturePropertyNode;78;1273.364,2340.012;Float;True;Property;_CircleTexture;CircleTexture;8;0;None;False;white;Auto;0;1;SAMPLER2D
...
Node;AmplifyShaderEditor.TexturePropertyNode;410;1261.871,1868.497;Float;True;Property;_BrushTexture;BrushTexture;4;0;None;False;white;Auto;0;1;SAMPLER2D
...
Node;AmplifyShaderEditor.TexturePropertyNode;337;1268.877,2101.855;Float;True;Property;_BrushStrokeTexture;BrushStrokeTexture;6;0;None;False;white;Auto;0;1;SAMPLER2D
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;5659.555,1595.829;Float;False;True;2;Float;ASEMaterialInspector;0;0;CustomLighting;CustomLightingTest_Terrain03;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;False;False;Off;0;0;False;0;0;Opaque;0.5;True;True;0;False;Opaque;Geometry;ForwardOnly;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;False;0;255;255;0;0;0;0;False;0;4;10;25;False;0.5;True;0;Zero;Zero;0;Zero;Zero;Add;Add;0;False;0;0,0,0,0;VertexOffset;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;0;0;14;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0.0;False;4;FLOAT;0.0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0.0;False;9;FLOAT;0.0;False;10;OBJECT;0.0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
WireConnection;746;0;742;0
WireConnection;745;0;741;0
WireConnection;744;0;743;0
WireConnection;748;0;745;0
WireConnection;748;1;746;0
WireConnection;748;2;744;1
WireConnection;750;0;748;0
WireConnection;750;1;746;0
WireConnection;750;2;744;2
...
WireConnection;752;2;744;3
WireConnection;754;0;752;0
WireConnection;754;1;753;0
WireConnection;754;2;744;4
...
WireConnection;733;1;754;0
WireConnection;733;2;740;0
WireConnection;697;0;754;0
...
ASEEND*/
//CHKSM=DF484B4F61A81EC6067CE01F68B675A33A8B2607