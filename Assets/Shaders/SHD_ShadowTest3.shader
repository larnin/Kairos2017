...
Shader "SHD_ShadowTest3"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 temp_cast_4 = (fresnelNode177).xxxx;
			...
			float4 lerpResult248 = lerp( float4( 0,0,0,0 ) , saturate( ( ( ( CalculateContrast(1.0,( tex2D( _Texture0, ( temp_output_224_0 + ( temp_output_226_0 * 0.1 ) ).xy ) + tex2D( _Texture0, appendResult230.xy ) )) * i.vertexColor ) * ( 1.0 - saturate( ( CalculateContrast(1.0,temp_cast_4) * fresnelNode197 ) ) ) ) * ( 1.0 - fresnelNode241 ) ) ) , _Alpha);
...
/*ASEBEGIN
Version=13201
1939;127;1684;906;-2249.357;-444.1159;1.616298;True;True
...
Node;AmplifyShaderEditor.TexturePropertyNode;190;1040.221,1454.917;Float;True;Property;_Clouds;Clouds;6;0;Assets/Textures/sf_noise_clouds_01.png;False;white;Auto;0;1;SAMPLER2D
...
Node;AmplifyShaderEditor.RangedFloatNode;246;3270.163,1345.371;Float;False;Property;_DispStrength;DispStrength;3;0;0;0;0;0;1;FLOAT
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;243;3197.777,1547.087;Float;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0,0,0,0;False;1;COLOR
...
Node;AmplifyShaderEditor.ColorNode;247;3580.163,736.3715;Float;False;Property;_Color;Color;0;0;0,0,0,0;0;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.LerpOp;248;3796.163,978.3715;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0.0;False;2;FLOAT;0,0,0,0;False;1;COLOR
...
ASEEND*/
//CHKSM=345D41D2DD6E4993FE798B6A1D2B529EE6FC5EA6